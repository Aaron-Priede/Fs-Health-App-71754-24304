...
import './UnfinishedMedications.css';

export default function UnfinishedMedications() {
  ...
  return (
    <div className="medications-container">
      <h2 className="medications-title">Unfinished Medications</h2>

      {unfinishedMeds.length === 0 ? (
        <div className="medications-empty">
          <p>No unfinished medications found.</p>
        </div>
      ) : (
        <div className="medications-list">
          {unfinishedMeds.map((med) => (
            <div key={med.id} className="medication-card">
              ...
              <div className="medication-details">
                ...
                <div className="medication-detail">
                  ...
                  <span className="detail-value status-unfinished">{med.status}</span>
                </div>
                <div className="medication-detail">
